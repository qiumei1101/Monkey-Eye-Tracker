/*******************************************************
* Open Source for Iris : MonkeyIris
* Version : 4.0
* Date : 2011
...
namespace MonkeyIris
{
    ...
    OsiManager::OsiManager ( )
    {
        ...
        mMapBool["Use the mask provided by MonkeyIris"] = &mUseMask ;
    ...
    // Show the configuration of MonkeyIris in prompt command
    void OsiManager::showConfiguration ( )
    {
        ...
        if ( ! mUseMask )
        {
            cout << " do not use MonkeyIris masks" ;
        }
        cout << endl ;
    ...
    void OsiManager::processOneEye ( const string & rFileName , OsiEye & rEye )
    {
        ...
        if ( mProcessSegmentation )
        {
            ...
            // If user don't want to use the mask provided by MonkeyIris
            if ( ! mUseMask )
            {
                rEye.initMask() ;
            }
	...
	void OsiManager::segmentImage(std::string ImageName)
	{
