...
{    
    ...
    {    
        ...
        cout<<"YTF "<<m<<endl;
        cvNamedWindow("src",0);  
        cvShowImage("src",shifted);  
        cvSaveImage("/home/sandy/2.jpg",shifted);
        */
        ...
        IplImage * best=cvCreateImage(cvGetSize(image1),IPL_DEPTH_8U,1) ;
        cvSet(best,cvScalar(0)) ;
        ...
        stringstream ss(dd);
        ss<<m;
        string name="/home/sandy/result"+ss.str()+".bmp";
        cvSaveImage(name.c_str(),best);
        char* data = (char*)best->imageData;
